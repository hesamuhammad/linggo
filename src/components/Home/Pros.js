                        ...
                        <Card style={{ borderStyle: "none", margin: "2%" }}>
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    fraction of the cost of traditional agencies
                                    so you can drive business in new markets at
                                    competitive rates.
                                </Card.Text>
                            </Card.Body>
                        ...
                        <Card style={{ borderStyle: "none", margin: "2%" }}>
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    across all major time zones, we can
                                    comfortably keep pace with your content
                                    needs, no matter the volume.
                                </Card.Text>
                            </Card.Body>
                            <Card.Footer style={{ backgroundColor: "white" }}>
                                <p
                        ...
                        <Card style={{ borderStyle: "none", margin: "2%" }}>
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    tools eliminate workflow inefficiency and
                                    boost consistency and quality across
                                    projects.
                                </Card.Text>
                            </Card.Body>
                            <Card.Footer style={{ backgroundColor: "white" }}>
